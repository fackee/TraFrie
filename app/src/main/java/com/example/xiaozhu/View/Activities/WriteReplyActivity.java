...
public class WriteReplyActivity extends BaseActivity implements View.OnClickListener,Toolbar.OnMenuItemClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar)findViewById(R.id.wr_toolbar);
        mToolbar.setNavigationIcon(R.drawable.ic_arrow_back_white_24dp);
        mToolbar.setNavigationOnClickListener(this);
        mToolbar.inflateMenu(R.menu.send_rec_head);
        mToolbar.setOnMenuItemClickListener(this);
        mEditText = (EditText)findViewById(R.id.wr_edit);
    }
